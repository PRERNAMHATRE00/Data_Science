...
insert into customers(customerid,customername)values(1,'abc');
insert into customers(customerid,customername)values(2,'pqr');
insert into customers(customerid,customername)values(3,'xyz');
insert into customers(customerid,customername)values(4,'mno');
